export const authStyles = {
  ...
  error: "text-sm font-medium leading-5 text-danger",
  field: "grid gap-1.5",
  form: "mt-7 grid gap-4",
  helper: "text-sm leading-5 text-muted",
  input:
    "min-h-11 w-full appearance-none rounded-control border border-input bg-field px-3.5 py-2.5 text-base font-normal leading-6 text-ink shadow-inner outline-hidden transition [font-size:16px] focus:border-brand focus:bg-white focus:ring-[3px] focus:ring-brand/20",
  kicker: "mb-2 mt-0 text-xs font-extrabold uppercase tracking-wide text-brand",
