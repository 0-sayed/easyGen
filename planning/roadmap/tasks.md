...
| [x]  | M    | `T018` — Account profile and password change API | `T010`, `T015`         | `feat/t018-account-security-api`       | `planning/context/technical/account-security-api.md`                                                                       |
...
| [x]  | M    | `T021` — Account settings frontend               | `T017`, `T018`         | `feat/t021-account-settings-frontend`  | `planning/context/business/account-settings-frontend.md`                                                                   |
