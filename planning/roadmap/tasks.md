...
| [ ]  | S    | `T005` — Public status documentation surface     | `T004`                 | `feat/t005-public-status-contract`     | `planning/context/technical/public-status-contract.md`                                                                     |
| [ ]  | S    | `T006` — Submission readiness pass               | `T003`, `T004`         | `chore/t006-submission-readiness`      | `planning/context/business/submission-readiness.md`                                                                        |
| [ ]  | S    | `T007` — Application copy and route polish       | `T003`                 | `feat/t007-auth-ux-polish`             | `planning/context/business/auth-ux-polish.md`                                                                              |
| [ ]  | M    | `T008` — Explicit API response contracts         | `T002`, `T004`         | `feat/t008-api-response-contracts`     | `planning/context/technical/api-response-contracts.md`                                                                     |
| [ ]  | M    | `T009` — Frontend session resilience             | `T003`, `T004`         | `feat/t009-session-resilience`         | `planning/context/business/session-resilience.md`                                                                          |
| [ ]  | M    | `T010` — User persistence contract coverage      | `T002`                 | `test/t010-user-persistence-contracts` | `planning/context/technical/user-persistence-contracts.md`                                                                 |
| [ ]  | L    | `T011` — Config and deployment readiness         | `T006`, `T008`         | `chore/t011-deployment-readiness`      | `planning/context/technical/deployment-readiness.md`                                                                       |
| [ ]  | L    | `T012` — Auth abuse guardrails and audit trail   | `T008`, `T010`         | `feat/t012-auth-guardrails-audit`      | `planning/context/technical/auth-guardrails-audit.md`                                                                      |
| [ ]  | L    | `T013` — Full-stack browser QA matrix            | `T007`, `T009`         | `test/t013-browser-qa-matrix`          | `planning/context/technical/browser-qa-matrix.md`                                                                          |
| [ ]  | L    | `T014` — Reviewer-facing application demo polish | `T007`, `T009`         | `feat/t014-reviewer-demo-polish`       | `planning/context/business/reviewer-demo-polish.md`                                                                        |
| [ ]  | L    | `T015` — Backend token revocation and logout API | `T008`, `T011`, `T012` | `feat/t015-token-revocation-logout`    | `planning/context/technical/token-revocation.md`                                                                           |
| [ ]  | L    | `T016` — Email verification token flow           | `T010`, `T011`, `T012` | `feat/t016-email-verification-flow`    | `planning/context/technical/email-verification.md`                                                                         |
| [ ]  | M    | `T017` — Typed frontend API client contracts     | `T008`, `T009`         | `feat/t017-typed-frontend-api-client`  | `planning/context/technical/frontend-api-client-contract.md`                                                               |
...
| 5    | [ ]  | `T005`                         | `feat/t005-public-status-contract`                                                                                                    |
| 6    | [ ]  | `T006`, `T007`                 | `chore/t006-submission-readiness`, `feat/t007-auth-ux-polish`                                                                         |
| 7    | [ ]  | `T008`, `T009`, `T010`         | `feat/t008-api-response-contracts`, `feat/t009-session-resilience`, `test/t010-user-persistence-contracts`                            |
| 8    | [ ]  | `T011`, `T012`, `T013`, `T014` | `chore/t011-deployment-readiness`, `feat/t012-auth-guardrails-audit`, `test/t013-browser-qa-matrix`, `feat/t014-reviewer-demo-polish` |
| 9    | [ ]  | `T015`, `T016`, `T017`         | `feat/t015-token-revocation-logout`, `feat/t016-email-verification-flow`, `feat/t017-typed-frontend-api-client`                       |
